...
// Number('abc') é NaN, e toda comparação com NaN é falsa: um valor de ambiente
// digitado errado fazia NENHUMA janela vencer nunca, e o registro passava a
// bloquear a agenda para sempre. Valor inválido cai no padrão.
const TTL_MS = (() => {
  const v = Number(process.env.VC_PRESENCA_TTL_MS);
