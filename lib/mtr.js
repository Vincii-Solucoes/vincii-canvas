...
// Guarda de reentrância: `rodada()` é assíncrona e pode demorar mais que o
// intervalo (um salto mudo espera o timeout do ping). Sem isto o setInterval
// abria uma rodada por cima da outra e os processos de ping se multiplicavam,
// até a máquina engasgar. O tique é pulado, não enfileirado.
let emCurso = false;
