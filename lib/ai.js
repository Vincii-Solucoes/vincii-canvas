...
function buildSystem({ host, terminalContext, modo, protocolo }) {
  ...
  if (modo === 'desktop') {
    ...
    const onde = host
      ? `a área de trabalho de ${host.host} (host "${host.name}") por ${qual}`
...
module.exports = { streamChat, generatePlaybook, publicSettings, getConfig, MODELS, KNOWN_MODELS, DEFAULT_MODEL, DEFAULT_TERM_FONT, DEFAULT_TERM_FONT_SIZE };
