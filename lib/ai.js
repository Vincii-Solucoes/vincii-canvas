...
async function streamChat({ messages, host, terminalContext, modo, protocolo, onDelta, signal }) {
  ...
  // Sem o sinal, fechar a aba no meio de uma resposta deixava o servidor
  // consumindo (e pagando) o restante da geração até o modelo terminar.
