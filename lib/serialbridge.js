...
// O renderer arma o modo ANTES de chamar requestPort(). Trocar de modo resolve
// quem estava esperando a lista da rodada anterior — senão o /api/serial/ports
// de uma enumeração abandonada penduraria até o timeout.
function definirModo(novoModo, portId) {
  if (esperandoLista.length) resolverEsperas(ultimaLista);
